...
if (!process.env.DISCORD_CLIENT_ID) {
    ...
    console.error('💡 Add DISCORD_CLIENT_ID to your .env file (find it in Discord Developer Portal)');
    process.exit(1);
}
...
async function deployCommands() {
    try {
        ...
        console.log(`🎯 Deployment mode: ${isGlobal ? 'GLOBAL' : `GUILD (${guildId})`}\n`);
        ...
        if (isGlobal) {
            ...
            console.log('⚠️  Global deployment can take up to 1 hour to propagate to all servers');
        } else {
